...
const realmCopy: Record<string, { name: string; tagline: string; description: string; caveat: string }> = {
  forest: { name: "Forest", tagline: "Rooted in renewal", description: "Explore a canopy and soil inspired point of view for home care. Each brew page shows its current ingredients, use and approval status.", caveat: "Source, safety and performance details appear on each brew page when reviewed." },
  ...
  mountain: { name: "Mountain", tagline: "Made for clarity", description: "Meet mineral inspired care and a design language shaped by elevation and simplicity.", caveat: "Household use and water related claims require product-specific testing." },
};
